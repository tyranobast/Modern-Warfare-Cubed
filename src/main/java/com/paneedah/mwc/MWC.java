...
@Mod(modid = ID, name = NAME, version = VERSION, dependencies = "required-after:redcore@[0.6,);after:groovyscript@[1.2,)", guiFactory = "com.paneedah.weaponlib.config.ConfigGUIFactory", updateJSON = "https://forge.curseupdate.com/836353/mwc")
